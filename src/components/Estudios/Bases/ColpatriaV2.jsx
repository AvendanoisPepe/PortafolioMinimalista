...
import col19 from "../../../assets/imagenes/trabajos/Colpatria/V2/col19.png";
import col20 from "../../../assets/imagenes/trabajos/Colpatria/V2/col20.png";
import col21 from "../../../assets/imagenes/trabajos/Colpatria/V2/col21.png";
import col22 from "../../../assets/imagenes/trabajos/Colpatria/V2/col22.png";
import col23 from "../../../assets/imagenes/trabajos/Colpatria/V2/col23.png";

const images = [col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20, col21, col22, col23];
  ...
  developments: [
    {
      ...
      icon: <GrUserAdmin />,
      description: {
        Es: "Modo admistrador que permite a los usuarios modificar, eliminar la informacion correspondiente a las bases de datos de las bibliotecas de informacion, de igual forma permite descargar y subir los mismos cambios realizados.",
        En: "Administrator mode that allows users to modify and delete information from information library databases, as well as download and upload the same changes made."
      },
      images: [images[18], images[19], images[20], images[21], images[22]],
    },
    {
      id: "checklist",
      name: {
    ...
    },
    {
      ...
      icon: <FaStickyNote />,
      description: {
        Es: "Sistema avanzado para crear y gestionar notas con formato enriquecido, donde se verifica campo por campo con sus diferentes validaciones, recolectando datos para formar la nota deseada. (El sistema esta enlazado con las macros)",
        En: "Advanced system for creating and managing rich-format notes, where field-by-field verification is performed with various validations, collecting data to create the desired note. (The system is linked to macros.)"
      },
