  ...
  developments: [
    {
      ...
      icon: <GrUserAdmin />,
      description:
        "Modo admistrador que permite a los usuarios modificar, eliminar la informacion correspondiente a las bases de datos de las bibliotecas de informacion, de igual forma permite descargar y subir los mismos cambios realizados.",
